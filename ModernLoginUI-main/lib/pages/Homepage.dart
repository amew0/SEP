...
import 'package:fbs/pages/allowance.dart';
import 'package:fbs/pages/login_page.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'package:fbs/pages/statement.dart';
...
class _HomepageState extends State<Homepage> {
  ...
  Future<dynamic> nfc_handle(user) async {
    ...
    final url = Uri.parse(
        'https://familybank.herokuapp.com/nfc'); // insert correct API endpoint
  ...
  Future<dynamic> statement(user) async {
    ...
    final url = Uri.parse(
        'https://familybank.herokuapp.com/statement'); // insert correct API endpoint
    final headers = {'Content-Type': 'application/json'};
  ...
  Future<void> logout(user) async {
    ...
    final url = Uri.parse(
        'https://familybank.herokuapp.com/logout'); // insert correct API endpoint
    final headers = {'Content-Type': 'application/json'};
